...
class Ui_Usuarios(object):
    def setupUi(self, Form):
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.BtnActualizar_2.sizePolicy().hasHeightForWidth()
        )
        ...
        self.BtnActualizar_2.setStyleSheet(
            "QPushButton {\n"
            "    background-color: #16344D; /* Color de fondo */\n"
            "    border-radius: 5px; /* Bordes redondeados */\n"
            "    color: white; /* Color del texto */\n"
        ...
        self.gridLayout_3.addWidget(
            self.TablaUsuarios, 2, 0, 1, 1, QtCore.Qt.AlignHCenter
        )
        ...
        self.checkActivo.setStyleSheet(
            "QCheckBox::indicator {\n"
            "    width: 24px;\n"
            "    height: 24px;\n"
        ...
        self.LineNombres.setStyleSheet(
            "QLineEdit {\n"
            "\n"
            "    background-color: #f5f5f5; /* Gris más claro cuando se escribe */\n"
            "    border: none; /* Sin bordes generales */\n"
        ...
        self.LineApellidos.setStyleSheet(
            "QLineEdit {\n"
            "\n"
            "    background-color: #f5f5f5; /* Gris más claro cuando se escribe */\n"
            "    border: none; /* Sin bordes generales */\n"
        ...
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(
            self.ComboRegional.sizePolicy().hasHeightForWidth()
        )
        ...
        self.ComboRegional.setStyleSheet(
            "QComboBox {\n"
            "    background-color: #f5f5f5; /* Mismo fondo gris claro que el QLineEdit */\n"
            "    border: none; /* Sin bordes generales */\n"
            "    border-bottom: 1px solid #CCCCCC; /* Borde inferior suave */\n"
