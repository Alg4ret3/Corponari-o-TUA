...
class Ui_Login(object):
    def setupUi(self, Form):
        ...
        self.label_7.setMinimumSize(QtCore.QSize(350, 150))
...
"    background-color: #16344D; /* Color de fondo */")
        ...
        self.verticalLayout.addWidget(self.label_7, 0, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignTop)
...
"font:18px;")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("assets/iconos/user.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"font:18px;")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("assets/iconos/padlock.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"")
        ...
        self.verticalLayout_2.addWidget(self.stackedWidget, 0, QtCore.Qt.AlignTop)
